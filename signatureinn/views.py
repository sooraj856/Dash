...
def dailyacs(request):
    ...
    my_dict = pyexcel.get_dict(file_name="C:\Python27\day25.4.xls", name_columns_by_row=0)
    records = pe.get_records(file_name="C:\Python27\day25.4.xls", name_columns_by_row=0)
